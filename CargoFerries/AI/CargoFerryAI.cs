...
public class CargoFerryAI : VehicleAI
{
    ...
    ref Vector3 swayPosition)
  {
    ...
    position.y = (float) (((double) worldPos1.y + (double) worldPos2.y + (double) worldPos3.y + (double) worldPos4.y) * 0.25);
  ...
  public override void CreateVehicle(ushort vehicleID, ref Vehicle data)
  {
    ...
    bool hasWater;
    data.m_frame0.m_position.y = Singleton<TerrainManager>.instance.SampleBlockHeightSmoothWithWater(data.m_frame0.m_position, false, 0.0f, out hasWater);
  ...
  public override void SimulationStep(ushort vehicleID, ref Vehicle data, Vector3 physicsLodRefPos)
  {
    ...
    else if ((data.m_flags & Vehicle.Flags.WaitingSpace) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive))
      this.TrySpawn(vehicleID, ref data);
    Vector3 lastFramePosition = data.GetLastFramePosition();
    int lodPhysics = (double) Vector3.SqrMagnitude(physicsLodRefPos - lastFramePosition) < 1210000.0 ? ((double) Vector3.SqrMagnitude(Singleton<SimulationManager>.instance.m_simulationView.m_position - lastFramePosition) < 250000.0 ? 0 : 1) : 2;
    ...
    if (data.m_leadingVehicle == (ushort) 0 && data.m_trailingVehicle != (ushort) 0)
    {
      ...
      while (vehicleID1 != (ushort) 0)
      {
        ...
        instance.m_vehicles.m_buffer[(int) vehicleID1].Info.m_vehicleAI.SimulationStep(vehicleID1, ref instance.m_vehicles.m_buffer[(int) vehicleID1], vehicleID, ref data, lodPhysics);
    ...
    if ((data.m_flags & (Vehicle.Flags.Spawned | Vehicle.Flags.WaitingPath | Vehicle.Flags.WaitingSpace)) == ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive) && data.m_cargoParent == (ushort) 0)
    {
    ...
    int lodPhysics)
  {
    ...
    float maxDistance = (float) (((double) num1 + (double) acceleration) * (0.5 + 0.5 * ((double) num1 + (double) acceleration) / (double) braking) + (double) this.m_info.m_generatedInfo.m_size.z * 0.5);
    ...
    int index = 0;
    bool flag1 = false;
    if (((double) f1 < (double) minSqrDistanceA || (double) vehicleData.m_targetPos3.w < 0.00999999977648258) && (leaderData.m_flags & (Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped)) == ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive))
    {
      if (leaderData.m_path != 0U)
      {
        this.UpdatePathTargetPositions(vehicleID, ref vehicleData, frameData.m_position, ref index, 4, minSqrDistanceA, minSqrDistanceB);
    ...
    if (leaderData.m_path != 0U)
    {
      ...
      {
        instance1.m_segments.m_buffer[(int) position.m_segment].AddTraffic(Mathf.RoundToInt(this.m_info.m_generatedInfo.m_size.z * 3f), this.GetNoiseLevel());
        if (((int) num4 & 1) == 0 || lastPathOffset == (byte) 0 || (leaderData.m_flags & Vehicle.Flags.WaitingPath) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive))
        {
          uint laneId = PathManager.GetLaneID(position);
          if (laneId != 0U)
            instance1.m_lanes.m_buffer[laneId].ReserveSpace(this.m_info.m_generatedInfo.m_size.z);
        }
        else if (instance2.m_pathUnits.m_buffer[leaderData.m_path].GetNextPosition((int) num4 >> 1, out position))
        {
          uint laneId = PathManager.GetLaneID(position);
          if (laneId != 0U)
            instance1.m_lanes.m_buffer[laneId].ReserveSpace(this.m_info.m_generatedInfo.m_size.z);
    ...
    float maxSpeed = (leaderData.m_flags & Vehicle.Flags.Stopped) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive) || (leaderData.m_flags2 & Vehicle.Flags2.Floating) == (Vehicle.Flags2) 0 ? 0.0f : vehicleData.m_targetPos0.w;
    ...
    if ((double) f1 > 1.0)
    {
      ...
      if ((double) len1 > 1.0)
      {
        ...
        float a1 = (double) vehicleData.m_targetPos0.w >= 0.100000001490116 ? Mathf.Min(Mathf.Min(maxSpeed, this.CalculateTargetSpeed(vehicleID, ref vehicleData, 1000f, curve)), CargoFerryAI.CalculateMaxSpeed(targetDistance1, vehicleData.m_targetPos1.w, braking * 0.9f)) : Mathf.Min(this.CalculateTargetSpeed(vehicleID, ref vehicleData, 1000f, curve), CargoFerryAI.CalculateMaxSpeed(targetDistance1, Mathf.Min(vehicleData.m_targetPos0.w, vehicleData.m_targetPos1.w), braking * 0.9f));
        float targetDistance2 = targetDistance1 + VectorUtils.LengthXZ((Vector3) (vehicleData.m_targetPos1 - vehicleData.m_targetPos0));
        float a2 = Mathf.Min(a1, CargoFerryAI.CalculateMaxSpeed(targetDistance2, vehicleData.m_targetPos2.w, braking * 0.9f));
        float targetDistance3 = targetDistance2 + VectorUtils.LengthXZ((Vector3) (vehicleData.m_targetPos2 - vehicleData.m_targetPos1));
        float a3 = Mathf.Min(a2, CargoFerryAI.CalculateMaxSpeed(targetDistance3, vehicleData.m_targetPos3.w, braking * 0.9f));
        float targetDistance4 = targetDistance3 + VectorUtils.LengthXZ((Vector3) (vehicleData.m_targetPos3 - vehicleData.m_targetPos2));
        ...
        if (!CargoFerryAI.DisableCollisionCheck(leaderID, ref leaderData))
          CargoFerryAI.CheckOtherVehicles(vehicleID, ref vehicleData, ref frameData, ref maxSpeed, ref blocked, ref zero2, maxDistance, braking * 0.9f, lodPhysics);
    ...
    else if ((double) num1 < (double) this.SlowDownThreshold(ref vehicleData) && flag1 && this.ArriveAtDestination(leaderID, ref leaderData))
    {
    ...
    if ((leaderData.m_flags & Vehicle.Flags.Stopped) == ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive) && (double) maxSpeed < 0.100000001490116)
      blocked = true;
    vehicleData.m_blockCounter = !blocked ? (byte) 0 : (byte) Mathf.Min((int) vehicleData.m_blockCounter + 1, (int) byte.MaxValue);
    Vector3 vector3_3;
    if ((double) len1 > 1.0)
    {
    ...
    bool hasWater;
    forward1.y = Singleton<TerrainManager>.instance.SampleBlockHeightSmoothWithWater(frameData.m_position + frameData.m_velocity, false, 0.0f, out hasWater) - frameData.m_position.y;
    if (hasWater)
    ...
    frameData.m_position += frameData.m_velocity * 0.5f;
    frameData.m_swayVelocity = frameData.m_swayVelocity * (1f - this.m_info.m_dampers) - vector3_5 * (1f - this.m_info.m_springs) - frameData.m_swayPosition * this.m_info.m_springs;
    frameData.m_swayPosition += frameData.m_swayVelocity * 0.5f;
    ...
    frameData.m_underground = (vehicleData.m_flags & Vehicle.Flags.Underground) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive);
    frameData.m_transition = (vehicleData.m_flags & Vehicle.Flags.Transition) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive);
    if ((vehicleData.m_flags & Vehicle.Flags.Parking) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive) && (double) len1 <= 1.0 && flag1)
    {
      ...
      if ((double) forward2.sqrMagnitude > 0.00999999977648258)
        frameData.m_rotation = Quaternion.RotateTowards(frameData.m_rotation, Quaternion.LookRotation(forward2), 15f);
    }
    else if ((double) f2 > 0.100000001490116)
    {
      forward1.y = 0.0f;
      if ((double) forward1.sqrMagnitude > 0.00999999977648258)
        frameData.m_rotation = Quaternion.RotateTowards(frameData.m_rotation, Quaternion.LookRotation(forward1), 15f);
    }
    else if ((double) f2 < -0.100000001490116)
    {
      forward1.y = 0.0f;
  ...
  private static bool DisableCollisionCheck(ushort vehicleID, ref Vehicle vehicleData) => (vehicleData.m_flags & Vehicle.Flags.Arriving) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive) && (double) Mathf.Max(Mathf.Abs(vehicleData.m_targetPos3.x), Mathf.Abs(vehicleData.m_targetPos3.z)) > 8640.0 - 100.0;
    ...
    float speed)
  {
    ...
    Vector4 vector4 = (double) sqrMagnitude <= (double) maxSqrDistance ? (Vector4) targetPos : (Vector4) (refPos + vector3 * Mathf.Sqrt(maxSqrDistance / sqrMagnitude));
    vector4.w = speed;
    return vector4;
  }
    ...
    ref Vehicle.Frame frameData)
  {
    ...
    Vector3 vector3_2 = frameData.m_rotation * new Vector3(0.0f, 0.0f, Mathf.Max(0.5f, (float) ((double) this.m_info.m_generatedInfo.m_size.z * 0.5 - 1.0)));
    ...
    int lodPhysics)
  {
    ...
    for (int index1 = num2; index1 <= num4; ++index1)
    {
      for (int index2 = num1; index2 <= num3; ++index2)
      {
        ...
        {
          otherID = CargoFerryAI.CheckOtherVehicle(vehicleID, ref vehicleData, ref frameData, ref maxSpeed, ref blocked, ref collisionPush, maxBraking, otherID, ref instance.m_vehicles.m_buffer[(int) otherID], min, max, lodPhysics);
          if (++num5 > 16384)
          {
            CODebugBase<LogChannel>.Error(LogChannel.Core, "Invalid list detected!\n" + System.Environment.StackTrace);
            break;
  ...
  private static ushort CheckOtherVehicle(
    ...
    int lodPhysics)
  {
    if ((int) otherID != (int) vehicleID && (int) vehicleData.m_leadingVehicle != (int) otherID && (int) vehicleData.m_trailingVehicle != (int) otherID)
    {
      ...
      if ((double) min.x < (double) vector3_2.x + 2.0 && (double) min.y < (double) vector3_2.y + 2.0 && ((double) min.z < (double) vector3_2.z + 2.0 && (double) vector3_1.x < (double) max.x + 2.0) && ((double) vector3_1.y < (double) max.y + 2.0 && (double) vector3_1.z < (double) max.z + 2.0))
      {
        ...
        if (lodPhysics < 2)
        {
          ...
          if ((double) num < 4.0)
          {
            ...
            if ((double) Vector3.Dot(lhs, vector3_3 - vector3_4) < 0.0)
              collisionPush -= lhs.normalized * (float) (0.100000001490116 - (double) num * 0.025000000372529);
            else
              collisionPush += lhs.normalized * (float) (0.100000001490116 - (double) num * 0.025000000372529);
            blocked = true;
          }
        ...
        float num2 = magnitude1 * (float) (0.5 + 0.5 * (double) magnitude1 / (double) info.m_braking) + Mathf.Min(1f, magnitude1);
        ...
        for (int index1 = 0; index1 < 4; ++index1)
        {
          ...
          if ((double) Vector3.Dot(lhs1, vector3_3) > 0.0)
          {
            ...
            segment1.a.y *= 0.5f;
            segment1.b.y *= 0.5f;
            if ((double) magnitude2 > 0.00999999977648258 && (double) min.x < (double) vector3_2.x + 2.0 && ((double) min.y < (double) vector3_2.y + 2.0 && (double) min.z < (double) vector3_2.z + 2.0) && ((double) vector3_1.x < (double) max.x + 2.0 && (double) vector3_1.y < (double) max.y + 2.0 && (double) vector3_1.z < (double) max.z + 2.0))
            {
              ...
              if ((double) segment1.DistanceSqr(a, out u) < 4.0)
              {
                ...
                {
                  float b = Mathf.Max(0.0f, CargoFerryAI.CalculateMaxSpeed(num5 - (targetSpeed + 3f), targetSpeed, maxBraking));
                  if ((double) b < 0.00999999977648258)
                    blocked = true;
                  Vector3 rhs = Vector3.Normalize((Vector3) otherData.m_targetPos0 - otherData.m_segment.a);
                  float num6 = (float) (1.20000004768372 - 1.0 / ((double) vehicleData.m_blockCounter * 0.0199999995529652 + 0.5));
              ...
              if (lodPhysics < 2)
              {
                ...
                for (int index2 = num6; index2 < 4 && (double) maxLength > 0.100000001490116; ++index2)
                {
                  ...
                  {
                    if (index2 == num6)
                      vector3_4 = Singleton<VehicleManager>.instance.m_vehicles.m_buffer[(int) otherData.m_leadingVehicle].m_segment.b;
                    else
                      break;
                  }
                  else
                  ...
                  if ((double) Vector3.Dot(lhs2, rhs) > 0.0)
                  {
                    ...
                    float num7;
                    float num8;
                    if ((double) magnitude3 > 0.00999999977648258 && ((int) otherID >= (int) vehicleID ? (double) segment1.DistanceSqr(segment2, out num8, out num7) : (double) segment2.DistanceSqr(segment1, out num7, out num8)) < 4.0)
                    {
                      float num9 = num4 + magnitude2 * num8;
                      float num10 = (float) ((double) num5 + (double) magnitude3 * (double) num7 + 0.100000001490116);
                      if ((double) num9 >= 0.00999999977648258 && (double) num9 * (double) num3 > (double) num10 * (double) num1)
                      {
                        float targetSpeed = Vector3.Dot(lastFrameData.m_velocity, vector3_3) / magnitude2;
                        if ((double) num9 >= 0.00999999977648258)
                        {
                          float b = Mathf.Max(0.0f, CargoFerryAI.CalculateMaxSpeed(num9 - (targetSpeed + 1f + otherData.Info.m_generatedInfo.m_size.z), targetSpeed, maxBraking));
                          if ((double) b < 0.00999999977648258)
                            blocked = true;
                          maxSpeed = Mathf.Min(maxSpeed, b);
                        }
    ...
    float minSqrDistanceB)
  {
    ...
    if (num2 == byte.MaxValue)
    {
      ...
      if (!Singleton<PathManager>.instance.m_pathUnits.m_buffer[num1].CalculatePathPositionOffset((int) num2 >> 1, (Vector3) vector4, out offset1))
      {
        ...
        while (true)
        {
            ...
            if (lane1.m_laneType != NetInfo.LaneType.CargoVehicle)
            {
              ...
              while ((int) offset1 != (int) position1.m_offset)
              {
                ...
                else
                {
                  ...
                  int num5 = (double) num4 >= 0.0 ? 4 + Mathf.Max(0, Mathf.CeilToInt((float) ((double) num4 * 256.0 / ((double) instance2.m_lanes.m_buffer[num3].m_length + 1.0)))) : 4;
                ...
                Vector3 pos1;
                float maxSpeed;
                this.CalculateSegmentPosition(vehicleID, ref vehicleData, position1, num3, offset1, out pos1, out Vector3 _, out maxSpeed);
          ...
          if (instance1.m_pathUnits.m_buffer[nextPath].GetPosition(index1, out position2))
          {
            ...
            if (info2.m_lanes.Length > (int) position2.m_lane)
            {
              ...
              if ((int) startNode2 == (int) startNode1 || (int) startNode2 == (int) endNode1 || ((int) endNode2 == (int) startNode1 || (int) endNode2 == (int) endNode1) || (((instance2.m_nodes.m_buffer[(int) startNode1].m_flags | instance2.m_nodes.m_buffer[(int) endNode1].m_flags) & NetNode.Flags.Disabled) != NetNode.Flags.None || ((instance2.m_nodes.m_buffer[(int) startNode2].m_flags | instance2.m_nodes.m_buffer[(int) endNode2].m_flags) & NetNode.Flags.Disabled) == NetNode.Flags.None))
              {
                if (lane2.m_laneType != NetInfo.LaneType.Pedestrian)
                {
                  if ((lane2.m_laneType & (NetInfo.LaneType.Vehicle | NetInfo.LaneType.CargoVehicle | NetInfo.LaneType.TransportVehicle)) != NetInfo.LaneType.None)
                  {
                    if (lane2.m_vehicleType == this.m_info.m_vehicleType || !this.NeedChangeVehicleType(vehicleID, ref vehicleData, position2, laneId, lane2.m_vehicleType, ref vector4))
                    {
                      if ((int) position2.m_segment != (int) position1.m_segment && vehicleID != (ushort) 0)
                        vehicleData.m_flags &= Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive;
                      byte offset2 = 0;
                      if ((vehicleData.m_flags & Vehicle.Flags.Flying) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive))
                        offset2 = position2.m_offset < (byte) 128 ? byte.MaxValue : (byte) 0;
                      else if ((int) num3 != (int) laneId && lane1.m_laneType != NetInfo.LaneType.CargoVehicle)
                      {
                        PathUnit.CalculatePathPositionOffset(laneId, (Vector3) vector4, out offset2);
                        bezier3 = new Bezier3();
                        Vector3 dir1;
                        this.CalculateSegmentPosition(vehicleID, ref vehicleData, position1, num3, position1.m_offset, out bezier3.a, out dir1, out float _);
                        bool flag = offset1 == (byte) 0;
                        if (flag)
                          flag = (vehicleData.m_flags & Vehicle.Flags.Reversed) == ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive) ? vehicleData.m_leadingVehicle == (ushort) 0 : vehicleData.m_trailingVehicle == (ushort) 0;
                        Vector3 dir2;
                        float maxSpeed;
                        if (flag)
                        {
                          PathUnit.Position position3;
                          if (!instance1.m_pathUnits.m_buffer[nextPath].GetNextPosition(index1, out position3))
                            position3 = new PathUnit.Position();
                          this.CalculateSegmentPosition(vehicleID, ref vehicleData, position3, position2, laneId, offset2, position1, num3, position1.m_offset, index, out bezier3.d, out dir2, out maxSpeed);
                        }
                        else
                          this.CalculateSegmentPosition(vehicleID, ref vehicleData, position2, laneId, offset2, out bezier3.d, out dir2, out maxSpeed);
                        if ((double) maxSpeed >= 0.00999999977648258 && (instance2.m_segments.m_buffer[(int) position2.m_segment].m_flags & (NetSegment.Flags.Collapsed | NetSegment.Flags.Flooded)) == NetSegment.Flags.None)
                        {
                          ...
                          dir2.Normalize();
                          float distance;
                          NetSegment.CalculateMiddlePoints(bezier3.a, dir1, bezier3.d, dir2, true, true, out bezier3.b, out bezier3.c, out distance);
                          if ((double) distance > 1.0)
                          {
                            ...
                            {
                              case 0:
                                nodeID = instance2.m_segments.m_buffer[(int) position2.m_segment].m_startNode;
                                break;
                              case byte.MaxValue:
                                nodeID = instance2.m_segments.m_buffer[(int) position2.m_segment].m_endNode;
                                break;
                              default:
                                nodeID = (ushort) 0;
                                break;
                            }
                            float curve = (float) (1.57079637050629 * (1.0 + (double) Vector3.Dot(dir1, dir2)));
                            if ((double) distance > 1.0)
                              curve /= distance;
                            maxSpeed = Mathf.Min(maxSpeed, this.CalculateTargetSpeed(vehicleID, ref vehicleData, 1000f, curve));
                            while (offset1 < byte.MaxValue)
                            {
                              float num4 = Mathf.Sqrt(f) - Vector3.Distance((Vector3) vector4, refPos);
                              int num5 = (double) num4 >= 0.0 ? 8 + Mathf.Max(0, Mathf.CeilToInt((float) ((double) num4 * 256.0 / ((double) distance + 1.0)))) : 8;
                              offset1 = (byte) Mathf.Min((int) offset1 + num5, (int) byte.MaxValue);
                              Vector3 vector3 = bezier3.Position((float) offset1 * 0.003921569f);
                              vector4.Set(vector3.x, vector3.y, vector3.z, Mathf.Min(vector4.w, maxSpeed));
                              if ((double) VectorUtils.LengthSqrXZ(vector3 - refPos) >= (double) f)
                              {
                                if (index <= 0)
                                  vehicleData.m_lastPathOffset = offset1;
                                if (nodeID != (ushort) 0)
                                  this.UpdateNodeTargetPos(vehicleID, ref vehicleData, nodeID, ref instance2.m_nodes.m_buffer[(int) nodeID], ref vector4, index);
                                ref Vehicle local = ref vehicleData;
                                int num6;
                                index = (num6 = index) + 1;
                                int index2 = num6;
                      ...
                      if (index <= 0)
                      {
                        ...
                        if (index1 >= (int) instance1.m_pathUnits.m_buffer[nextPath].m_positionCount - 1 && instance1.m_pathUnits.m_buffer[nextPath].m_nextPathUnit == 0U && vehicleID != (ushort) 0)
                      ...
                      if (index <= 0)
                      {
                        vehicleData.m_pathPositionIndex = num2;
                        vehicleData.m_lastPathOffset = offset1;
                        vehicleData.m_flags = vehicleData.m_flags & (Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive) | info2.m_setVehicleFlags;
...
label_37:
        ...
        return;
label_39:
        if (vehicleID == (ushort) 0 || (vehicleData.m_flags & Vehicle.Flags.Parking) != ~(Vehicle.Flags.Created | Vehicle.Flags.Deleted | Vehicle.Flags.Spawned | Vehicle.Flags.Inverted | Vehicle.Flags.TransferToTarget | Vehicle.Flags.TransferToSource | Vehicle.Flags.Emergency1 | Vehicle.Flags.Emergency2 | Vehicle.Flags.WaitingPath | Vehicle.Flags.Stopped | Vehicle.Flags.Leaving | Vehicle.Flags.Arriving | Vehicle.Flags.Reversed | Vehicle.Flags.TakingOff | Vehicle.Flags.Flying | Vehicle.Flags.Landing | Vehicle.Flags.WaitingSpace | Vehicle.Flags.WaitingCargo | Vehicle.Flags.GoingBack | Vehicle.Flags.WaitingTarget | Vehicle.Flags.Importing | Vehicle.Flags.Exporting | Vehicle.Flags.Parking | Vehicle.Flags.CustomName | Vehicle.Flags.OnGravel | Vehicle.Flags.WaitingLoading | Vehicle.Flags.Congestion | Vehicle.Flags.DummyTraffic | Vehicle.Flags.Underground | Vehicle.Flags.Transition | Vehicle.Flags.InsideBuilding | Vehicle.Flags.LeftHandDrive))
          return;
...
label_51:
        ...
        if (index <= 0)
        {
          ...
          if (vehicleID == (ushort) 0 || this.ChangeVehicleType(vehicleID, ref vehicleData, position2, laneId))
            return;
          this.InvalidPath(vehicleID, ref vehicleData, vehicleID, ref vehicleData);
          return;
        }
...
label_76:
  ...
  private static bool CheckOverlap(Segment3 segment, ushort ignoreVehicle, float maxVelocity)
  {
    ...
    for (int index1 = num2; index1 <= num4; ++index1)
    {
      for (int index2 = num1; index2 <= num3; ++index2)
      {
        ...
        while (otherID != (ushort) 0)
        {
          otherID = CargoFerryAI.CheckOverlap(segment, ignoreVehicle, maxVelocity, otherID, ref instance.m_vehicles.m_buffer[(int) otherID], ref overlap);
          if (++num5 > 16384)
          {
            CODebugBase<LogChannel>.Error(LogChannel.Core, "Invalid list detected!\n" + System.Environment.StackTrace);
            break;
  ...
  private static float CalculateMaxSpeed(float targetDistance, float targetSpeed, float maxBraking)
  {
    ...
    return Mathf.Sqrt(Mathf.Max(0.0f, (float) ((double) num2 * (double) num2 + 2.0 * (double) targetDistance * (double) maxBraking))) - num1;
  }
    ...
    out float maxSpeed)
  {
    ...
    float num = (float) (0.5 * (double) lastFrameData.m_velocity.sqrMagnitude / (double) this.m_info.m_braking + (double) this.m_info.m_generatedInfo.m_size.z * 0.5);
    if ((double) VectorUtils.LengthXZ(position1 - position2) >= (double) num - 5.0 && !instance.m_lanes.m_buffer[laneID].CheckSpace(1000f, vehicleID))
    {
    ...
    if (info.m_lanes != null && info.m_lanes.Length > (int) position.m_lane)
      maxSpeed = this.CalculateTargetSpeed(vehicleID, ref vehicleData, info.m_lanes[(int) position.m_lane].m_speedLimit, instance.m_lanes.m_buffer[laneID].m_curve);
    else
    ...
    bool undergroundTarget)
  {
    ...
    float distanceSqrA1;
    float distanceSqrB1;
    bool flag1 = PathManager.FindPathPosition(startPos, ItemClass.Service.PublicTransport, NetInfo.LaneType.Vehicle, info.m_vehicleType, false, false, 64f, out pathPosA1, out pathPosB1, out distanceSqrA1, out distanceSqrB1);
    PathUnit.Position pathPosA2;
    PathUnit.Position pathPosB2;
    float distanceSqrA2;
    float distanceSqrB2;
    bool flag2 = PathManager.FindPathPosition(endPos, ItemClass.Service.PublicTransport, NetInfo.LaneType.Vehicle, info.m_vehicleType, false, false, 64f, out pathPosA2, out pathPosB2, out distanceSqrA2, out distanceSqrB2);
    PathUnit.Position pathPosA3;
    PathUnit.Position pathPosB3;
    float distanceSqrA3;
    float distanceSqrB3;
    if (PathManager.FindPathPosition(startPos, ItemClass.Service.Beautification, NetInfo.LaneType.Vehicle, info.m_vehicleType, false, false, 64f, out pathPosA3, out pathPosB3, out distanceSqrA3, out distanceSqrB3) && (!flag1 || (double) distanceSqrA3 < (double) distanceSqrA1))
    {
      pathPosA1 = pathPosA3;
      pathPosB1 = pathPosB3;
    ...
    float distanceSqrA4;
    float distanceSqrB4;
    if (PathManager.FindPathPosition(endPos, ItemClass.Service.Beautification, NetInfo.LaneType.Vehicle, info.m_vehicleType, false, false, 64f, out pathPosA4, out pathPosB4, out distanceSqrA4, out distanceSqrB4) && (!flag2 || (double) distanceSqrA4 < (double) distanceSqrA2))
    {
      pathPosA2 = pathPosA4;
      pathPosB2 = pathPosB4;
    ...
    if (flag1 && flag2)
    {
      ...
      uint unit;
      if (Singleton<PathManager>.instance.CreatePath(out unit, ref Singleton<SimulationManager>.instance.m_randomizer, Singleton<SimulationManager>.instance.m_currentBuildIndex, pathPosA1, pathPosB1, pathPosA2, pathPosB2, NetInfo.LaneType.Vehicle, info.m_vehicleType, 20000f, false, this.IgnoreBlocked(vehicleID, ref vehicleData), false, false))
      {
